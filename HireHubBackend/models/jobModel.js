...
const jobSchema = new mongoose.Schema({
    ...
    requirements: { //List of job requirements or qualifications
        type: [String],
        required: true
    },
    ...
    categories:{
        type: String,
        required: true, // e.g., Full-time, Part-time, Contract, Internship
        enum: ['Information Technology (IT)', 'Healthcare','Education','Human Resources','Accountant','Customer Service']
    },
    deadline: {
        type: Boolean,
    },
