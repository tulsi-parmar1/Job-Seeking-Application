...
function JobDetail() {
    ...
    return (
        <>
            <div style={{ display: 'flex', marginTop: '150px',justifyContent:'center',gap:'70px'}} className={style.jobdetail}>
                <div> <JobDetailSub job={job} applicants={applicants} id={id}></JobDetailSub>
                </div>
                <div>
                    <SimilarJobs id={id}></SimilarJobs></div>
                </div>
